      ...
      <Sider width={200} className="site-layout-background">
        ...
        >
          <SubMenu key="sub1" icon={<UserOutlined />} title="销售">
            <Menu.Item key="1"><Link to='/main/sub1/option1'>产品</Link></Menu.Item>
            <Menu.Item key="2"><Link to='/main/sub1/option2'>地点</Link></Menu.Item>
            <Menu.Item key="3"><Link to='/main/sub1/option3'>销售订单</Link></Menu.Item>
            <Menu.Item key="4"><Link to='/main/sub1/option4'>客户</Link></Menu.Item>
          </SubMenu>
          <SubMenu key="sub2" icon={<LaptopOutlined />} title="库存">
            <Menu.Item key="5"><Link to='/main/sub2/option5'>库存</Link></Menu.Item>
